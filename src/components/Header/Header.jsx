...
const Header = () => {
  ...
  const routes = [
    { label: 'Home', path: '/', options: [{ label: 'Option 1', path: '/home/option1' }, { label: 'Option 2', path: '/home/option2' }, { label: 'Option 3', path: '/home/option3' }] },
    ...
    { label: 'Cars', path: '/cars', options: [{ label: 'Option 1', path: '/car/option1' }, { label: 'Option 2', path: '/car/option2' }, { label: 'Option 3', path: '/car/option3' }] },
